package clase3.Matematica.clases;
...
public class MisCalculos {
    ...
    public static double ingresaNumero(String mensaje) {
        boolean error = false;
        double valor = 0;
        do {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Debe ingresar un número válido.", "Error",
